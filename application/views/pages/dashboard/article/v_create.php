                    ...
                    <div class="row">
                        <form action="<?= base_url('dash/article/store') ?>" method="post" class="rom g-3" enctype="multipart/form-data">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <input type="hidden" name="isi_artikel" value='<?= $this->session->flashdata('content_artikel') ?>' class="form-control">
                                <div id="content_artikel" style="height: 150px;"><?= $this->session->flashdata('content_artikel') ?></div>
                            </div>
